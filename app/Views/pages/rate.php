<?= $this->extend('layout/bintang')?>
<?= $this->section('header')?>

    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">PT. Pilar Solusi</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="tables.html">
                                <div class="sb-nav-link-icon"><i class="fa fa-star checked"></i></div>
                                Rating
                            </a>
                        </div>
                    </div>
                    <div class="sb-sidenav-footer">
                        <div class="small">Made On:</div>
                        PKL pilar solusi
                    </div>
                </nav>
            </div>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active" href="">Dashboard</li>
                        </ol>
                        <div class="row">
    ...
    <div class="col-md-8 course-details-content">
      <div class="course-details-card mt--40">
        <div class="course-content">
          <h5 class="mb--20">Rating Kantor Kami</h5>
